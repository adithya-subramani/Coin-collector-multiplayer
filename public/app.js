...
import { getDatabase,ref,set,onDisconnect,onValue,onChildAdded,onChildRemoved,remove,update } from 'https://www.gstatic.com/firebasejs/9.1.2/firebase-database.js'
...
function isSolid(x,y) {
  ...
  const blockedNextSpace = mapData1.blockedSpaces[getKeyString(x, y)];
  return (
    blockedNextSpace ||
    x >= mapData1.maxX ||
    x < mapData1.minX ||
